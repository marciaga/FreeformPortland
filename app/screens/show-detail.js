...
const navOptions = {
    screen: 'PlaylistDetail', // unique ID registered with Navigation.registerScreen
    title: 'Playlist Detail', // navigation bar title of the pushed screen (optional)
...
export const ShowDetail = ({ navigator }) => {
    return (
        <Container
